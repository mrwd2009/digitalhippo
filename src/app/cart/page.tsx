  ...
  return (
    <div className="bg-white">
      <div className="mx-auto max-w-2xl px-4 pb-24 pt-16 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div className="mt-12 lg:grid lg:grid-cols-12 lg:items-start lg:gap-x-12 xl:ga-x-16">
                  ...
                  <li key={product.id} className="flex py-6 sm:py-10">
                    <div className="flex-shrink-0">
                      <div className='relative h-24 w-24'>
                        <Image src={(image as Media).url!} fill alt="" className="h-full w-full rounded-md object-cover object-center sm:h-48 sm:w-48" />
                      </div>
                    </div>
                      ...
                      <div className="relative pr-9 sm:grid sm:grid-cols-2 sm:gap-x-6 sm:pr-0">
                        ...
                        <div className="mt-4 sm:mt-0 sm:pr-9 w-20">
                          <div className="absolute right-0 top-0">
                            <Button aria-label="remove product" variant="ghost" onClick={() => {
          ...
          <section className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6 lg:col-span-5 lg:mt-0 lg:p-8">
              ...
              <div className="mt-6">
                ...
                }} className="w-full" size="lg">{ isLoading ? <Loader2 className="w-4 h-4 animate-spin mr-1.5" /> : null}Checkout</Button>
              </div>
          </section>
        </div>
      </div>
